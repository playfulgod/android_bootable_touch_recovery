...
RECOVERY_VERSION := $(RECOVERY_NAME) v5.5.0.4 Beta 6

LOCAL_CFLAGS += -DRECOVERY_VERSION="$(RECOVERY_VERSION)"
RECOVERY_API_VERSION := 2
LOCAL_CFLAGS += -DRECOVERY_API_VERSION=$(RECOVERY_API_VERSION)

BOARD_RECOVERY_DEFINES := BOARD_TOUCH_BUTTON_HEIGHT_43 BOARD_TOUCH_BUTTON_HEIGHT_64 BOARD_TOUCH_IMAGE_SIZE BOARD_TOUCH_BUTTON_HEIGHT BOARD_HC_TOUCH BOARD_FY_TOUCH BOARD_XDPI_RECOVERY BOARD_HAS_NO_SELECT_BUTTON BOARD_HAS_SMALL_RECOVERY BOARD_LDPI_RECOVERY BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT
